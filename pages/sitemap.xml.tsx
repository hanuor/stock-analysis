...
export const getServerSideProps: GetServerSideProps = async ({ res }) => {
	const pages = [
		...
		'actions/bankruptcies/statistics/',
		...
		'actions/acquisitions/statistics/',
