...
import mapData from "@Data/income_statement"; // varies by page

const data_name = "income_statement"; // varies by page
const title = "Income Statement"; // varies by page
...
export default function FinancialsPage(props) {
	...
	for (let i = 0; i < count; i++) {
		const rawDate = rawdata.datekey[i];
