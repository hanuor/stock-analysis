...
import mapData from "@Data/cash_flow_statement"; // varies by page

const data_name = "cash_flow_statement"; // varies by page
const title = "Cash Flow Statement"; // varies by page
