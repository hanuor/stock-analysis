		...
		<LayoutFullWidth title="About Us">
			<section className="bg-gray-100 py-20">
				<div className="container max-w-screen-md text-center">
					...
					<p className="text-lg">Example searches: <Link href="/stocks/aapl/">Apple</Link>, <Link href="/stocks/tsla/">Tesla</Link>, <Link href="/stocks/msft/">MSFT</Link>, <Link href="/stocks/amzn/">AMZN</Link></p>
				</div>
			</section>
		</LayoutFullWidth>
	);
