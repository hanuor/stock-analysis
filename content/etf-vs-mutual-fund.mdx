...
Holding a diversified fund is considered less risky than holding individual stocks, and many of these funds have excellent [long-term returns](https://stockanalysis.com/average-monthly-stock-returns/).
...
![Portfolio management with etf and mutual fund](https://stockanalysis.com/wp-content/uploads/2020/04/porfolio-management-etf-and-mutual-fund-1024x538.jpg)
...
You can trade an ETF at any time during [market hours](https://stockanalysis.com/stock-market-hours/), but you can only buy or sell a mutual fund investment at the end of the trading day.
...
The term index fund can apply to both an ETF and a mutual fund. An index fund simply means that it is a fund that tracks an index of stocks, [bonds](https://stockanalysis.com/stocks-vs-bonds/), or other assets. For example, index funds that track the S&P500 stock index are very popular.
...
Sometimes, these companies will provide [basically the same](https://www.bogleheads.org/wiki/ETFs_vs_mutual_funds) fund as either an ETF or mutual fund.

For example, Vanguard provides an ETF with the symbol [VTI](https://stockanalysis.com/voo-vs-vti/) and a mutual fund with the symbol VTSAX. Both are "total stock market" index funds that have a similar expense ratio and hold the same stocks.
...
If you make a profit from an ETF, then you only pay a capital gains tax when that profit is realized -- either when you sell the shares for a profit or receive a [dividend payment](https://stockanalysis.com/how-often-are-dividends-paid/).
...
Some funds get really excellent [returns](https://stockanalysis.com/term/roe-return-on-equity/) over time, while others lose money. It simply depends on the performance of the fund's assets or trading strategies.
...
You can even buy funds that invest in more complicated financial products, like leveraged [short selling](https://stockanalysis.com/how-to-short-stocks/) or volatility indexes. Some of these will lose 100% of their value over time.
...
-  **Active management** - In some cases, a mutual fund will be run by an incredibly effective manager that beats the market over the long-term. However, this is [the exception](https://stockanalysis.com/can-you-beat-the-market/) rather than the rule.
...
In fact, simply buying and holding the [S&P500 stock index](https://stockanalysis.com/what-is-the-best-sp500-etf/) has historically provided better returns than over 90% of professionally managed investment funds.

Even [Warren Buffett](https://stockanalysis.com/warren-buffett-money/) recommends that regular investors do this instead of trying to beat the market by picking stocks.
