...
The PEG ratio (price/earnings to growth) is a useful stock valuation measure. It is calculated by dividing a stock's [price-to-earnings](https://stockanalysis.com/term/pe-ratio/) (PE) ratio with the company's earnings growth.
...
At the time of this writing, the stock price is $102.78, while its [earnings per share](https://stockanalysis.com/term/eps-earnings-per-share/) (EPS) in the last 12 months is $4.35. If we divide the stock price with the earnings per share number, we see that Microsoft has a PE ratio of 23.62.
...
Based on the PEG ratio alone, this would imply that [Microsoft stock](https://stockanalysis.com/stocks/msft/) is a little expensive, while [Facebook](https://stockanalysis.com/stocks/fb/) is undervalued.
