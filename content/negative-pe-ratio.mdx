...
Generally speaking, a high [PE ratio](https://stockanalysis.com/term/pe-ratio/) indicates that a stock is expensive, while a low PE ratio suggests that it is cheap.
...
However, [earnings per share](https://stockanalysis.com/term/eps-earnings-per-share/) is sensitive to various accounting methods, so it doesn't always imply that a stock is a bad investment. It depends on many factors.
...
What a negative EPS means is that the stock had negative [net income](https://stockanalysis.com/term/net-income/) (net losses) in the trailing twelve months. In other words, adding up the earnings for the past four fiscal quarters results in a negative number.
...
1. **Struggling business:** The company might truly be struggling and is consistently spending more cash than it takes in just to stay afloat. This company has a high chance of [bankruptcy](https://stockanalysis.com/stocks-in-bankruptcy/) and is likely a bad investment.
...
3. **Biotech stocks:** It is very common for biotech stocks to have little to no [revenue](https://stockanalysis.com/term/revenue/) and high expenses. But they may be working on a new drug that will become immensely valuable in the near future.
...
One good way to see whether negative earnings and negative PE are caused by accounting is to look at [the cash flow statement](https://stockanalysis.com/term/cash-flow-statement/).
...
However, it can be risky to invest in unprofitable growth companies and biotech stocks. Don't [buy stocks](https://stockanalysis.com/how-to-buy-stocks-online/) in such companies unless you know what you're doing.
...
Let's imagine two hypothetical [stocks](https://stockanalysis.com/stocks/) that each cost $100 per share.
...
Most good financial information websites (including [Stock Analysis](https://stockanalysis.com/)) don't even show the PE ratio if it's negative.
