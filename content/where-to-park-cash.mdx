...
The most permanent option is to [switch to a brokerage](https://stockanalysis.com/how-to-buy-stocks-online/) that pays a significant interest on the cash balance in your account.

My main brokerage account is with [Interactive Brokers](https://www.interactivebrokers.com/en/home.php), which pays up to a [1.35% yield](https://www.interactivebrokers.com/en/index.php?f=interest&p=schedule) on all cash above 10,000 USD.
...
I generally park my cash in the [iShares Short Treasury Bond ETF](https://stockanalysis.com/etf/shv/) (SHV). It has an expense ratio of 0.15% and currently has a yield of 1.69%, with interest paid at the start of each month.
