...
If you know a company's stock price and its [earnings per share](https://stockanalysis.com/term/eps-earnings-per-share/), then it is very easy to calculate the PE ratio. You simply divide the stock price with the EPS.
...
Another way to calculate the PE ratio is by dividing the company's [market cap](https://stockanalysis.com/term/market-capitalization/) with its total net income.
...
[Microsoft stock](https://stockanalysis.com/stocks/msft/) (MSFT) was trading at $165 per share and its EPS in the prior 12 months was $5.30.
...
As another example, [General Motors stock](https://stockanalysis.com/stocks/gm/) (GM) was trading at $34.31 and their EPS in the prior 12 months was $6.14.
...
The standard PE ratio uses the [trailing twelve months](https://stockanalysis.com/term/ttm-trailing-twelve-months/) (TTM) EPS number. This is the combined earnings per share for the last four quarters.
...
This is a valuation metric called the [PEG ratio](https://stockanalysis.com/peg-ratio/) (Price/Earnings to Growth).
...
A stock with negative earnings per share also has a [negative PE ratio](https://stockanalysis.com/negative-pe-ratio/).

Many finance websites (including [Stock Analysis](https://stockanalysis.com/)) don't show the PE ratio if EPS is negative because a negative PE ratio isn't very informative. Instead, they show n/a, which stands for "not applicable."
...
For example, the PE ratio of [Amazon](https://stockanalysis.com/stocks/amzn/) has often been negative or very high, but the company was growing quickly and gaining market share at the same time.

## Limitations of the PE Ratio

The PE ratio is very popular because it is easy to understand and easy to calculate.

But it still has significant limitations, so it should not be used in isolation to determine whether a stock is worth [buying](https://stockanalysis.com/how-to-buy-stocks-online/).
...
For example, companies that have positive EPS can have negative [free cash flow](https://stockanalysis.com/term/free-cash-flow/), meaning that they are spending more money than they earn despite being "profitable" based on accounting earnings.
...
-  [Return on Equity (ROE)](https://stockanalysis.com/term/roe-return-on-equity/)
