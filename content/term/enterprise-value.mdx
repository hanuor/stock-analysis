...
Enterprise value (EV) is a metric that measures the total value of a company. It is more comprehensive than [market capitalization](https://stockanalysis.com/term/market-capitalization/) because it also accounts for the company's cash and debt levels.
...
![Enterprise value formula](https://stockanalysis.com/wp-content/uploads/2019/12/enterprise-value-formula.png)
...
-  **Outstanding Debt:** The sum of short-term and long-term debt on the company's [balance sheet](https://stockanalysis.com/term/balance-sheet/).
...
Apple ([AAPL](https://stockanalysis.com/stocks/aapl/)) has 4.38 billion shares oustanding and a stock price of $323. This gives them a market cap of 4.38 billion \* $323 = $1,415 billion.
...
CVS Health ([CVS](https://stockanalysis.com/stocks/cvs/)) has a market cap of $93 billion, with $8 billion in cash and $90 billion in debt. This gives them an enterprise value of $93B + $90B - $8B = $175B.
...
-  **EV/FCF:** The EV to free cash flow ratio uses [free cash flow](https://stockanalysis.com/term/free-cash-flow/) instead of earnings as the denominator.
...
The [PE ratio](https://stockanalysis.com/term/pe-ratio/) (price to earnings) can be calculated by dividing a company's market cap by its earnings in the past 12 months.
...
As an example, Verizon ([VZ](https://stockanalysis.com/stocks/vz/)) stock has a PE ratio of 12.6, which seems relatively cheap. But if you use enterprise value instead of market cap, then the EV/Earnings ratio is 23.
...
-  [Market Capitalization](https://stockanalysis.com/term/market-capitalization/)
