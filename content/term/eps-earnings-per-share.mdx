...
Earnings per share is calculated by dividing the company's [total earnings](https://stockanalysis.com/term/net-income/) by the total number of shares outstanding.
...
Total earnings is the same as net income on the [income statement](https://stockanalysis.com/term/income-statement/). It is also referred to as profit. You can find net income and shares outstanding on a company's income statement.
...
-  Earnings per share is used to calculate the [PE ratio](https://stockanalysis.com/term/pe-ratio/), the most commonly used valuation metric for stocks.
...
-  The most commonly used version is the trailing twelve months ([TTM](https://stockanalysis.com/term/ttm-trailing-twelve-months/)) EPS, which can be calculated by adding up the number for the past four quarters.
