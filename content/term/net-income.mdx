...
You calculate net income for a company by starting with [revenue](https://stockanalysis.com/term/revenue/), then subtracting all expenses: cost of revenue, operating expenses, interest, taxes, and others.
...
![Net income formulas](https://stockanalysis.com/wp-content/uploads/2020/02/net-income-formulas.png)
...
You can also calculate net income for a stock by subtracting all the expense items on the company's income statement [from the revenue](https://stockanalysis.com/revenue-vs-income/).
...
This screenshot shows the income statement from Facebook's [2019 annual report](https://www.sec.gov/Archives/edgar/data/1326801/000132680119000009/fb-12312018x10k.htm):
...
Net income (profits) can be used for various purposes. These include paying back debt, buying other companies, or returning money to shareholders via [dividends](https://stockanalysis.com/how-often-are-dividends-paid/) and stock buybacks.
...
Net income is also used to calculate [earnings per share](https://stockanalysis.com/term/eps-earnings-per-share/) (EPS). This is the profitability metric most closely followed by investors and [stock analysts](https://stockanalysis.com/analyst-ratings-explained/).

**Formula: EPS = Net Income / Shares Outstanding.**

The frequently cited [PE ratio](https://stockanalysis.com/term/pe-ratio/) can also be calculated using net income, by dividing a company's market cap by the net income in the past 12 months.
...
For a company, [gross income](https://stockanalysis.com/term/gross-profit/) is also different from net income.
...
Here's a screenshot from Apple's 2019 [financial statements](https://d18rn0p25nwr6d.cloudfront.net/CIK-0000320193/c0dc1bce-6ba9-4131-af22-54dab3277c8e.html) showing gross profit, operating income, and net income.

![Apple revenue and income](https://stockanalysis.com/wp-content/uploads/2020/02/apple-revenue-and-income.png)
