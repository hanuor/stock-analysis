...
[Net income](https://stockanalysis.com/term/net-income/) can be found on the company's income statement, but shareholders' equity is listed on the balance sheet. Shareholders' equity is often simply called equity. It is the same as book value and also called net assets or net worth.
...
A high return on equity makes it attractive for investors to not only invest in the business but also retain money in the business instead of [paying it out](https://stockanalysis.com/how-often-are-dividends-paid/) as dividends.
...
![Return on equity formula](https://stockanalysis.com/wp-content/uploads/2020/04/roe-return-on-equity.png)

Net income for the last 12 months is usually shown on finance websites as "Net Income ([TTM](https://stockanalysis.com/term/ttm-trailing-twelve-months/)). Preferred dividends are subtracted before calculating the net income in the ROE formula.
...
Using the average shareholders' equity during the past twelve months helps account for the different nature of the [balance sheet](https://stockanalysis.com/term/balance-sheet/) compared to the income statement.
...
As in, for a company's financials for a year, the [income statement](https://stockanalysis.com/term/income-statement/) will show everything that happened between January 1 and December 31. But the balance sheet will only show a snapshot of the financial status on December 31.
...
However, many consider an ROE in the ballpark of 15-20% to be acceptable. To put that in perspective, the S&P500 index had a return on equity of [15.29%](https://csimarket.com/Industry/industry_ManagementEffectiveness.php?sp5) in 2019.
...
Let's imagine that you're thinking about investing in [Facebook stock](https://stockanalysis.com/stocks/fb/) and want to know how its ROE compares to similar companies.
...
-  [Alphabet / Google](https://stockanalysis.com/stocks/googl/) - 18%
-  [Twitter](https://stockanalysis.com/stocks/twtr/) - 19%
-  [The Trade Desk](https://stockanalysis.com/stocks/ttd/) - 21.5%

By comparing Facebook to similar companies that also get the majority of their revenue [from digital ads](https://stockanalysis.com/how-facebook-makes-money/), you see that Facebook's ROE of 20% is in line with industry peers. It is neither good or bad relative to the industry.
...
Additionally, [stock buybacks](https://stockanalysis.com/why-stock-buybacks-are-good/) lead to reduced shareholders' equity, so large-scale buybacks can inflate ROE by reducing the equity part of the formula.
...
However, it is just one of many financial ratios and has several limitations. It needs to be considered in context with other [financial metrics](https://stockanalysis.com/financial-dictionary/), as well as the company's overall prospects.
