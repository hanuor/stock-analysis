...
It is one of the three core financial statements, the others being the [balance sheet](https://stockanalysis.com/term/balance-sheet/) and the [cash flow statement](https://stockanalysis.com/term/cash-flow-statement/).

On the income statement, [revenue](https://stockanalysis.com/term/revenue/) is listed at the top and is often referred to as the "top-line."

All the key costs and expense items are listed below and then subtracted from the revenue. After all the expenses have been subtracted, the [profit](https://stockanalysis.com/term/net-income/) or loss is listed near the bottom of the statement. The profit/loss is termed the "bottom-line."
...
Apple ([AAPL](https://stockanalysis.com/stocks/aapl/)) is a complicated business with many different sources of revenue and expenses. Their income statement is a great way to see a simplified overview of how the business is performing.
...
Publicly traded companies also list the number of shares outstanding on the income statement. Then they calculate [earnings per share](https://stockanalysis.com/term/eps-earnings-per-share/) (EPS) by dividing the net income/loss by the number of shares outstanding.
...
However, multi-step income statements have four steps, each arriving at a different level of income. A multi-step income statement calculates [gross profit](https://stockanalysis.com/term/gross-profit/), operating income, pre-tax income, and net income (profit or loss).
...
-  **Operating income:** After all operating expenses have been subtracted from the gross profit, the amount that is left is the [operating income](https://stockanalysis.com/term/operating-income/). This is the profitability number for the core operations of the business.
...
-  **Investment gains/losses:** These can be significant if the company owns [stocks](https://stockanalysis.com/stocks/) or other investments that tend to go up and down in price.
...
Here's an example from Gamestop's ([GME](https://stockanalysis.com/stocks/gme/)) income statement for 2018. They sold off a big part of their business, so many of the financials are broken down into continuing and discontinued categories.
...
-  Sometimes the [year-over-year](https://stockanalysis.com/term/yoy-year-over-year/) (YoY) change in financials is shown on the income statement, for example for revenue growth.
...
[Stock analysts](https://stockanalysis.com/analyst-ratings-explained/) closely follow income statements and use them for financial modeling.
...
Understanding how the income statement, balance sheet, and cash flow statement work is crucial in order to be a well-informed [stock investor](https://stockanalysis.com/how-to-buy-stocks-online/).

### Related terms

-  [Revenue](https://stockanalysis.com/term/revenue/)
...
-  [Balance Sheet](https://stockanalysis.com/term/balance-sheet/)
