...
Investors and others often use the market cap to determine a company's size, because it is a more convenient metric for this than [revenue](https://stockanalysis.com/term/revenue/) or earnings.
...
![Market capitalization formula](https://stockanalysis.com/wp-content/uploads/2019/11/market-capitalization-formula.png)
...
To find a company's market cap, search for their name [on this page](https://stockanalysis.com/stocks/). The stock overview page will list the company's market cap, as well as the number of shares outstanding and current stock price.
...
A related metric called [enterprise value](https://stockanalysis.com/term/enterprise-value/) is more useful than market cap in many cases.
...
Market cap is also sometimes used to measure the size of entire stock exchanges, stock markets, or regions. According to the [World Bank](https://data.worldbank.org/indicator/CM.MKT.LCAP.CD), the total global market cap of all public companies was $68.6 trillion US dollars at the end of 2018.
