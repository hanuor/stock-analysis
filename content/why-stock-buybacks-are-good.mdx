...
The single most important driver of stock prices is the [earnings per share](https://stockanalysis.com/term/eps-earnings-per-share/) (EPS) number. When it goes up, the stock usually follows, and vice versa.
...
The [PE ratio](https://stockanalysis.com/term/pe-ratio/) is the most commonly used valuation metric to quickly determine if a stock is cheap or expensive.
...
In the past, dividend payments used to be the main way for companies to return cash to shareholders. But some [new rules in 1982](https://www.bloomberg.com/opinion/articles/2018-03-27/congress-would-make-a-mistake-by-banning-share-buybacks) made share buybacks more popular, and now they are considered more tax-friendly and flexible ([1](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=2715098)).

The following graph shows how share buybacks became the preferred method of returning cash to shareholders after 1982:

![Dividend yield vs buyback yield chart](https://stockanalysis.com/wp-content/uploads/2019/02/dividend-yield-vs-buyback-yield-chart.png)

Source: [Straehl, Philip U. and Ibbotson, Roger G., The Supply of Stock Returns: Adding Back Buybacks (December 17, 2015).](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=2715098)

Most investors need to [pay a tax](https://en.wikipedia.org/wiki/Dividend_tax) on their dividend payments, which amounts to 0-40% in the US. On the other hand, investors don't need to pay a tax from the share price going up until they sell, when they will have to pay a capital gains tax.
...
[Dividends](https://stockanalysis.com/how-often-are-dividends-paid/) are also subject to double taxation. First the company pays a tax on its profits, but then you pay the second round of tax after getting the dividend.
...
If a [recession](https://stockanalysis.com/who-determines-recessions/) hits, then the company can just pause the buyback program. But if they had committed to a dividend payment, then it would be much harder to cut the dividend.
...
For example, if company management is sacrificing investments in long-term growth in favor of share repurchases, this can have a negative effect as the company will be missing future [revenue](https://stockanalysis.com/term/revenue/) opportunities.
