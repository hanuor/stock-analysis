...
Most stocks pay [dividends](https://stockanalysis.com/term/dividend/) every three months, after the company releases the quarterly earnings report.
...
In addition, many companies prefer to return cash to shareholders via [stock buybacks](https://stockanalysis.com/why-stock-buybacks-are-good/) instead of dividends. Doing this has some tax-related benefits for investors since long-term capital gains often have a lower tax rate than dividends.
...
If you then decide to sell the stock [when the market opens](https://stockanalysis.com/stock-market-hours/) on January 2nd, then you will still get paid.
...
For example, if you own 100 [shares of Microsoft](https://stockanalysis.com/stocks/msft/), which pays a 46-cent dividend per share each quarter, then the cash position in your brokerage account will go up by $46 on the payment date.
...
Then you can cash the check and deposit the money into your [brokerage account](https://stockanalysis.com/how-to-buy-stocks-online/) to buy more stock, or withdraw it as cash and spend it.
...
For example, [CVS Health](https://stockanalysis.com/stocks/cvs/) pays an annual dividend of $2.00. Dividing the annual amount by four gives you the quarterly payment -- $2.00 / 4 = $0.50.
...
Dividends are cash payments that companies pay directly to their shareholders. The money is taken from recent [profits](https://stockanalysis.com/term/eps-earnings-per-share/) or the company's cash reserves.
...
These types of stocks not only grow their share price, but the dividend payment also tends to increase each and [every year](https://stockanalysis.com/term/yoy-year-over-year/).
