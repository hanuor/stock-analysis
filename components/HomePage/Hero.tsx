...
export const Hero = () => (
	<>
		<section className="bg-gray-100 py-12 md:pb-28 md:pt-24 lg:pb-44 lg:pt-36 border-b border-gray-200 shadow-sm px-4 landscape:border-t-2 landscape:md:border-t-0">
