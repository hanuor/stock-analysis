...
const people = [
	{
		...
		bio: "Kris is a full-time investor and internet entrepreneur. He founded Stock Analysis in 2019. He has a Bachelor's degree in medicine.",
				...
				<div className="space-y-12 lg:grid lg:grid-cols-3 lg:gap-8 lg:space-y-0">
					<div className="space-y-5 sm:space-y-4">
						...
						<p className="text-xl text-gray-500">
							...
							currently manage the entire site and everything that comes
							with it.
						</p>
					</div>
